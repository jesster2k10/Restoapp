...
export const MAKE_BRAINTREE_PAYMENT     = 'MAKE_BRAINTREE_PAYMENT'.toLowerCase();
export const MAKE_BRAINTREE_PAYMENT_FAILED   = 'MAKE_BRAINTREE_PAYMENT_FAILED'.toLowerCase();
export const MAKE_BRAINTREE_PAYMENT_SUCCESS   = 'MAKE_BRAINTREE_PAYMENT_SUCCESS'.toLowerCase();
