...
function handleAction ({ navigate, goBack }, back, cart, action) {
    if (back) {
        goBack();
        return;
    }
...
const NavigationButton = ({back, navigation, cart, productCount, action, icon, size }) => {
    return (
        <TouchableOpacity onPress={() => handleAction(navigation, back, cart, action)}>
